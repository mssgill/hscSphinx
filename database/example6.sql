...
SELECT 
      pm.id, pm.ra2000, pm.decl2000, pm.gmag_sinc, pm.gmag_sinc_err, pm.rmag_sinc, pm.rmag_sinc_err, 
...
WHERE obj.id=pm.id and obj.tract=pm.tract and obj.patch=pm.patch and obj.pointing = pm.pointing 
  and obj.id=mfi.object_id and obj.tract=mfi.tract and obj.patch=mfi.patch and obj.pointing = mfi.pointing 
  and obj.id=mfr.object_id and obj.tract=mfr.tract and obj.patch=mfr.patch and obj.pointing = mfr.pointing 
