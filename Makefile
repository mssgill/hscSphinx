...
silver:
	tar cvf developer/simpleTools.tar developer/simpleTools
	@echo
	$(SPHINXBUILD) -b html $(ALLSPHINXOPTS) /home/silverman/public_html/hscsphinx
	@echo
	@echo "Build finished.  The HTML pages were *installed* in /home/silverman/public_html/hscsphinx."
...
qthelp:
	...
	@echo "# qcollectiongenerator $(BUILDDIR)/qthelp/HSCData.qhcp"
	@echo "To view the help file:"
	@echo "# assistant -collectionFile $(BUILDDIR)/qthelp/HSCData.qhc"
...
devhelp:
	...
	@echo "Build finished."
	@echo "To view the help file:"
	@echo "# mkdir -p $$HOME/.local/share/devhelp/HSCData"
	@echo "# ln -s $(BUILDDIR)/devhelp $$HOME/.local/share/devhelp/HSCData"
	@echo "# devhelp"
